...
function showProgress(){
    ...
    document.innerHTML = "Question" + currentQuestionNumber + "of " + quiz.questions.length;
}
...
var questions = [
    ...
    new Question("Which language is used for styling Websites?", ["HTML", "jQuery", "CSS", "XML"], "CSS"),
